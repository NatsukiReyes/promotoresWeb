        ...
        <h3><b>Noticias</b></h3>
         <section id="noticia">
               <?php 
                ...
                $sql="SELECT noticias.id_noticia, noticias.fecha, categorias.nombre, noticias.vistas, noticias.imagen, noticias.titulo, noticias.descripcion, noticias.fuente FROM categorias, noticias WHERE categorias.id_categoria=noticias.id_categoria AND categorias.nombre='noticias' ORDER BY id_noticia DESC";  
