        ...
        <h3><b>Música</b></h3>
         <section id="noticia">
               <?php 
                ...
                $sql="SELECT noticias.id_noticia, noticias.fecha, categorias.nombre, noticias.vistas, noticias.imagen, noticias.titulo, noticias.descripcion, noticias.fuente FROM categorias, noticias WHERE categorias.id_categoria=noticias.id_categoria AND categorias.nombre='musica' ORDER BY id_noticia DESC";  
